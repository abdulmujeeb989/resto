  ...
  @include('include.lang_section')
   <nav class="navbar navbar-expand-lg navbar-light bg-light osahan-nav p-3">
      <div class="container resto_title_div">
         ...
         <a href="https://api.whatsapp.com/send?phone={{$hotel_info_arr['whatsapp_number']}}" target="_blank"><img width="52px" height="45px" src="{!! env('APP_ASSETS') !!}img/exported_images/whatsapp.png" class="img-fluid whatsapp-img"></a>
      </div>
   </nav>
                  ...
                  <?php
                   ...
                   <li class="nav-item p-2">
                     <a class="nav-link filter_btn <?php if($key==0){ ?> active <?php } ?>" href="#category-<?php echo $value['id'] ?>">
                      <div class="img-div">
                        <img  class="scrollSpy-img lazyload"  width="100" height="auto"  data-srcset="<?php echo $img_path;?>">
                      </div>
                      ...
                      <?php
                        ...
                        foreach ($category['recipes'] as $key => $value) :
                         $data=$value;   
                          ...
                          $obj=json_encode(array("id"=>$data['id'],"name"=>$data['name'],"price"=>(float) str_replace(',', '',$data['price']),"tk"=>$rest_uid,'img'=>$data['thumbnail'],'description'=>$cat));
                        ...
                        <div class="food-items-wrap row mt-2">
                          <div class="col-8 d-flex justify-content-between plc-0">
                            <div class="d-flex justify-content-end">
                               <div style="background-image: url(<?php echo $data['main_image'];?>)" class="recepie_img_div">
