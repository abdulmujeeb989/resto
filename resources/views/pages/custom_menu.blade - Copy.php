      ...
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-md-12">
           ...
           <div class="row mt-1">
           	 <div class="d-flex justify-content-between  mb-0 col-md-12 p-1 m_list_div" data-id="1" tabindex="1">
        		<div class="col-1">
        			<p class="qty_txt1 text-qty">0</p>
        		</div>
        		<div class="col-7 mt-2">
        			<p>Crispy Manchurian Roll (VEG)</p>
        		</div>
        		<div class="col-4 mt-2 d-flex flex-row bd-highlight">
        			<p class="pr-2">44 AED</p>
        			<a class="close_anchor1">
        			  <img src="{!! env('APP_ASSETS') !!}img/Shape 6@2x.png" data-id="1" class="close_icon"> 	
        			</a>
        			
        		</div>
              </div>
              <div class="d-flex justify-content-between  mb-0 col-md-12 p-1 m_list_div" data-id="2" tabindex="2">
        		<div class="col-1">
        			<p class="qty_txt2 text-qty">0</p>
        		</div>
        		<div class="col-7 mt-2">
        			<p>Crispy Manchurian Roll (VEG)</p>
        		</div>
