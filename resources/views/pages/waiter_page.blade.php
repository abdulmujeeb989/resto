...
.chip.chip-lg 
{
	...
	border-radius: 26px;
               ...
               <div class="col-md-3">
                  ...
                  <div class="osahan-account-page-left shadow-sm bg-white h-100">
                     ...
                     <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
                        <li class="nav-item">
                          <a href='#notification_tab_div' class="nav-link" id="addresses-tab2" data-toggle="tab" role="tab" aria-controls="addresses2" aria-selected="false">
                            <i class="icofont-restaurant"></i>New Orders <span class="badge badge-pill badge-danger ml-2 notif-count">0</span>
                          </a>
                        </li>
                        <li class="nav-item">
                  ...
                  <div class="osahan-account-page-right shadow-sm bg-white p-4 h-100">
                     <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="addresses" role="tabpanel" aria-labelledby="addresses-tab">
                           <h4 class="font-weight-bold mt-0 mb-4">Pending Orders <span  class="badge badge-dark pnd_count"><?php echo $count_pending;?></h4>
                        ...
                        <div class="tab-pane fade " id="notification_tab_div" role="tabpanel" aria-labelledby="addresses-tab1">
                           <h4 class="font-weight-bold mt-0 mb-4">New Pending Orders</h4>
      ...
      <audio autoplay="autoplay"  playsinline id="myAudio" src="{!! env('APP_ASSETS') !!}media/notification.mp3" type="audio/mpeg"></audio>
      <input type="button" value="PLAY" id="playbtn" onclick="play()"> 
      ...
      <script type="text/javascript">
        ...
        $('.osahan-menu-fotter').hide();
         ...
         var notificationsWrapper   = $('.dropdown-notifications');
          ...
          var old_pending_count     = parseInt($('.pnd_count').text());
         ...
         {  
            ...
            if(result && result.length!=0)
            {
              ...
              var newNotificationHtml = `<li class="nav-item">
              ...
              old_pending_count+=1;
              $('.pnd_count').text(old_pending_count)
